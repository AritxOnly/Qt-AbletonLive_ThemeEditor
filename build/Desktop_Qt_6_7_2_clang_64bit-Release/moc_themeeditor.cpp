...
struct qt_meta_stringdata_CLASSThemeEditorENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSThemeEditorENDCLASS = QtMocHelpers::stringData(
    "ThemeEditor"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSThemeEditorENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ThemeEditor::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSThemeEditorENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSThemeEditorENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSThemeEditorENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ThemeEditor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSThemeEditorENDCLASS.stringdata0))
